...
*/
  ...
  pos.Set ("X", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=1250.0]"));
  pos.Set ("Y", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=1250.0]"));
  Ptr<PositionAllocator> taPositionAlloc = pos.Create ()->GetObject<PositionAllocator> ();
  
  
  mobility.SetMobilityModel ("ns3::RandomDirection2dMobilityModel", "Bounds", RectangleValue (Rectangle (0.0, 1250.0, 0.0, 1250.0)));
